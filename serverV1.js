...
app.delete('/api/incomes/:id', async (req, res) => {
    ...
    try {
      const result = await pool.query('DELETE FROM incomes WHERE id = $1 RETURNING *', [incomeId]);
...
app.post('/api/auth/refresh', async (req, res) => {
  ...
  const newAccessToken = jwt.sign({ userId: user.id }, secretKey, { expiresIn: '5h' });
...
// INSERT INTO incomes (amount, category, date, reference, title, userId)
// VALUES
//   (1000, 'Salary', '2022-01-15', 'REF001', 'January Salary', 'user1'),
//   (1200, 'Bonus', '2022-02-10', 'REF002', 'February Bonus', 'user2');

// -- Insert new data into the expenses table with date in 'YYYY-MM-DD' format
// INSERT INTO expenses (amount, category, date, reference, title, userId)
// VALUES
//   (200, 'Groceries', '2022-01-05', 'EXP001', 'Weekly Groceries', 'user1'),
//   (150, 'Utilities', '2022-02-20', 'EXP002', 'Electricity Bill', 'user2');
